...
# https://images.wallpaperscraft.com/image/single/sand_relief_surface_134513_1600x900.jpg"
...
# "Get Started" button to redirect to the Calculating Soil Recommendation page
if st.button("Get Started"):
    st.write("Redirecting to Calculating Soil Recommendation page...")
    # Logic for redirection to the calculation page goes here
    st.switch_page("D:\\Uni Projects\RS Project\pages\\2_🌱_Calculating Soil Recommendation.py")
